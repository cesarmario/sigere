					...
					<div class="popup dropdown-menu dropdown-menu-right">
                        <div class="thumbnail">
                            <div class="caption text-center">
                                <h6><?PHP echo $_SESSION['sesion_UserNom'];?> <small>Matricula: <?PHP echo $_SESSION['sesion_UserMat'];?></small>
                                </h6>                                
                            </div>
                        </div>
                        <ul class="list-group">
	 	...
	 	<div class="page-content">
    		...
    		<form class="form-horizontal" role="form" action="funciones/abm_practicas.php" method="GET">
                ...
                <?PHP
					...
					FROM practicas_main,obras_sociales,instituciones
	                ...
	                <div class="panel-body">
                        ...
                        <div class="form-group">
							...
							<div class="col-md-2">
                                ...
                                value="<?PHP echo date ( 'd-m-Y' , strtotime ( $prac['fecha'] ) ); ?>" name="fecha" tabindex="2" required >
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" value="<?PHP echo $prac['paciente']; ?>" name="paciente" tabindex="5"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea rows="5" cols="5" class="form-control" value="<?PHP echo $prac['observ']; ?>"
                                placeholder="Detalle" name="observ" tabindex="12"></textarea>
							</div>
						</div>
