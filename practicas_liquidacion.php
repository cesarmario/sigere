    		...
    		<form class="form-horizontal" role="form" action="funciones/abm_practicas.php" method="GET">
		        ...
		        <div class="panel panel-default">
	                <div class="panel-body">
							...
							<div class="col-sm-10">
								<div class="row">
									<div class="col-sm-6 has-feedback has-feedback-left">
										...
										<input type="text" class="form-control" value="<?PHP echo $_REQUEST['id_bono'];?>"
                                         name="id" disabled>
                        ...
                        <div class="form-group">
							<label class="col-sm-2 control-label">Nro. Liquidaci&oacute;n: </label>
							<div class="col-sm-10">
								<div class="row">
									<div class="col-sm-6 has-feedback has-feedback">
										<input type="text" class="form-control" name="liquidacion_nro" 
                                        value="<?PHP if($_REQUEST['fn']=="prac_liq_m"){ echo $_REQUEST['liquidacion_nro'];}?>" required>
									</div>
								</div>
							</div>
						</div>
                        ...
                        <div class="form-group">
							<label class="col-sm-2 control-label">Importe Liquidaci&oacute;n: </label>
							<div class="col-sm-10">
								<div class="row">
									<div class="col-sm-6 has-feedback has-feedback">

										<input type="text" class="form-control" name="liquidacion_imp"
                                        value="<?PHP if($_REQUEST['fn']=="prac_liq_m"){ echo $_REQUEST['liquidacion_imp'];}?>">
									</div>
								</div>
							</div>
						</div>
                        ...
                        <div class="form-group">
							<label class="col-sm-2 control-label">Fecha Liquidaci&oacute;n: </label>
							<div class="col-md-2">
                            	<input type="text" class="form-control" data-mask="99/99/9999" 
                                placeholder="99/99/9999" name="liquidacion_fec"
                                value="<?PHP if($_REQUEST['fn']=="prac_liq_m"){ echo date('d/m/Y',strtotime($_REQUEST['liquidacion_fec']));}?>">
							</div>
						</div>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                name="liquidacion_obs"><?PHP if($_REQUEST['fn']=="prac_liq_m"){ echo $_REQUEST['liquidacion_obs'];}?></textarea>
							</div>
						</div>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                            <input type="hidden" id="fn" name="fn" value="prac_liq_u"/>
