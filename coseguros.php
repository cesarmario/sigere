				...
				<ul class="navigation">
					...
					<li>
						...
						<ul>
                            ...
                            <li class="active"><a href="#">Coseguros</a></li>
                ...
                <div class="col-sm-10">
                    <div class="row">
                        <div class="col-sm-6 has-feedback has-feedback">
                            ...
                            <input type="hidden" id="fn" name="fn" value="cos_a"/>                           
                        </div>
			            ...
			            <div class="panel panel-default">
                            ...
                            <div class="table">
				                <table class="table">
                            		...
                            		$query="SELECT * FROM coseguros WHERE baja = 0";
				                    ...
				                    <tbody>
				                        <tr>
                                            ...
                                            <div class="table-controls">
                                                <a href="editar_datos.php?id=<?PHP echo $nn['id'];?>&nombre=<?PHP echo $nn['nombre'];?>&fn=cos_u"
