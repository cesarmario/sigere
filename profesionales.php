	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Profesionales <small></small></h3>
				</div>
			</div>
			<!-- /page header -->
                ...
                <div class="col-sm-10">
                    <div class="row">
                        <div class="col-sm-2 has-feedback has-feedback">
                            ...
                            <input type="hidden" id="fn" name="fn" value="pf_c"/>                           
                        </div>
					 		<input type="submit" value="Agregar" class="btn btn-primary">
                            <input type ='button' value = 'Cambiar' onClick="location.replace('funciones/chg_profesional.php');" class="btn btn-primary"/>
                    </div>
                </div>
            </div>
            	...
            	<div class="col-md-6">
                	...
                	<div class="tab-pane active fade in" id="inside">     
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Profesionales </h6></div>
                            ...
                            <div class="table">
				                <table class="table">
                            		...
                            		$query="SELECT * FROM profesionales WHERE baja = 0";
									$result = mysqli_query($conexion, $query);?>
                                    <?PHP while($nn=mysqli_fetch_assoc($result)){?>
				                    <tbody>
				                        <tr>
                                            <td><?PHP echo utf8_encode($nn["matricula"]); ?></td>
                                            ...
                                            <div class="table-controls">
												...
												$mt=$nn['matricula'];
												?>
                                                <a href="editar_datos.php?id=<?PHP echo $mt?>&nombre=<?PHP echo $nm;?>&fn=pf_u"
