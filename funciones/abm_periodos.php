...
if ($_GET[fn]=='periodo_s'){ //Funcion Insertar practicas_main
	/*echo "USER: " . $_POST[usu] . "<br>";
	echo "PASS:" . $_POST[pass]. "<br>"*/;
	$periodo_a = $_GET[periodo_a];
	$periodo_m = $_GET[periodo_m];
	...
	$_SESSION['sesion_PeridoM']  = $row['periodo_m'];  // (variables de sesion) ?>
	<script> location.replace("../periodos.php"); </script>
	<?PHP }else{

	// redirecciono	a pantalla de inicio ?> 
