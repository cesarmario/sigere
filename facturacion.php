			            ...
			            <div class="panel panel-default">
			                ...
			                <div class="table-responsive">
				                <table class="table">
				                    ...
				                    <tbody>
				                        <tr valign="top">
				                            <td valign="top"><?PHP echo $fac['paciente']; if($fac['dni']!=0) { echo " " . $fac['dni'];}?></td>
                                            ...
                                            <td valign="top">
                                                ...
                                                <a href="cirugias_modificar.php?id=<?PHP echo  $fac['id'];?>"
                                                class="btn btn-success btn-icon btn-xs tip">&nbsp;Cirugia&nbsp;</a>
                                                <br>&nbsp;
                                                </div>
												
                                                <div class="table-controls">
                                                <a href="practicas_abm.php?id_bono=<?PHP echo  $fac['id_bono'];?>&mod=1"
                                                class="btn btn-success btn-icon btn-xs tip">Detalles</a>
                                                <br>&nbsp;
                                            	</div>
												
                                                <div class="table-controls">
                                                <!--a href="funciones/abm_practicas.php?id_bono=<?PHP /* echo  
												$fac['id_bono'];*/?>&fn=prac_main_b"
                                                class="btn btn-warning btn-icon btn-xs tip">Eliminar</a -->
												
                                                <!--a href="eliminar_datos.php?id_bono=<?PHP echo  
												$fac['id_bono'];?>&nombre=<?PHP echo  
												$fac['paciente'];?>&fn=prac_main_b"
                                                class="btn btn-warning btn-icon btn-xs tip">Eliminar</a>
                                            	</div-->
												<div class="btn-group">
													...
													<ul class="dropdown-menu icons-right dropdown-menu-right">
														<li><a href="cirugias_modificar.php?id=<?PHP echo  $fac['id'];?>">
														<i class="icon-pencil4"></i> 
														Editar Cirugia</a></li>
														
														<li><a href="practicas_abm.php?id_bono=<?PHP echo  $fac['id_bono'];?>&mod=1">
														<i class="icon-pencil4"></i> Editar Detalles</a></li>
														
														<li><a href="eliminar_datos.php?id_bono=<?PHP echo $fac['id_bono'];?>&nombre=<?PHP echo $fac['paciente'];?>&fn=prac_main_b">
														<i class="icon-remove2"></i> 
														Eliminar Cirugia</a></li>
													</ul>
												</div>
                                            </td>
				                        </tr>
