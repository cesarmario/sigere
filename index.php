 	...
 	<div class="page-container">
		...
		<div class="sidebar">
			<div class="sidebar-content">
				...
				<!-- Main navigation -->
				<ul class="navigation">
					<li class="active"><a href="index.html"><span>Inicio</span> <i class="icon-screen2"></i></a></li>
					<li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Sistema de Control de Cirugias <small>Pantalla de Principal</small></h3>
				</div>
			</div>
			<!-- /page header -->
							...
							<div class="col-sm-10">
								<div class="row">
									<div class="col-sm-6 has-feedback has-feedback-left">
                                        ...
                                        value="<?PHP echo $_SESSION['sesion_ProfNom'];?>" name="id_usu" disabled >
							...
							<div class="col-sm-10">
								<div class="row">
									<div class="col-sm-6 has-feedback has-feedback-left">
                                        ...
                                        value="<?PHP echo $_SESSION['sesion_ProfMat'];?>" name="id_usu" disabled >
                                        <i class="icon icon-certificate form-control-feedback"></i>
									</div>
								</div>
							</div>
						</div>
