...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activar para ordenar columna ascendente",sSortDescending:": activar para ordenar la columna descendente"},oPaginate:{sFirst:"Primero",sLast:"Ultimo",sNext:"Proximo",sPrevious:"Previo"},sEmptyTable:"No hay datos disponibles en la tabla",sInfo:"Mostrando _START_ de _END_ of _TOTAL_ registros",sInfoEmpty:"Mostrando 0 to 0 of 0 entries",sInfoFiltered:"(filtrado de _MAX_ total entradas)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Mostrar _MENU_ entries",sLoadingRecords:"Cargando...",sProcessing:"Procesando...",sSearch:"Buscar:",sUrl:"",sZeroRecords:"No se encontraron registros"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};S(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,bSortable:!0,bVisible:!0,fnCreatedCell:null,
