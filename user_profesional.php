			...
			<form name="login" action="funciones/ctrl_profesional.php" role="form" method="POST">
				...
				<div class="well">
					...
					<div class="form-group has-feedback">
						...
						<select data-placeholder="Seleccione el profesional..." class="select-full" tabindex="2" name="matricula" required <?PHP if ($_SESSION['sesion_ProfMat'] > 0) { ?>disabled <?PHP } ?>>
							<option selected value="<?PHP if ($_SESSION['sesion_ProfMat'] > 0) {
														echo $_SESSION['sesion_ProfMat'];
													} ?>">
