                ...
                <div class="col-sm-10">
                    <div class="row">
                        <div class="col-sm-6 has-feedback has-feedback">
                            ...
                            <input type="hidden" id="fn" name="fn" value="inst_a"/>                           
                        </div>
            	...
            	<div class="col-md-6">
                	...
                	<div class="tab-pane active fade in" id="inside">     
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> </h6></div>
                            ...
                            <div class="table">
				                <table class="table">
                            		...
                            		$query="SELECT * FROM instituciones WHERE baja = 0"; 
				                    ...
				                    <tbody>
				                        <tr>
                                            ...
                                            <div class="table-controls">
                                                <a href="editar_datos.php?id=<?PHP echo $nn['id'];?>&nombre=<?PHP echo $nn['nombre'];?>&fn=inst_u"
