							...
							<div class="col-sm-10">
								<div class="row">
									<div class="col-sm-6 has-feedback has-feedback-left">
                                        ...
                                        value="<?PHP echo $_SESSION['sesion_ProfMat'];?>" name="matriula" disabled >
                                        <i class="icon icon-checkmark3 form-control-feedback"></i>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-10">
								<div class="row">
									<div class="col-sm-6 has-feedback has-feedback-left">
                                		...
                                		<input type="submit" value="Cambiar Contrase&ntilde;a" id="cambiaspsw" name="cambiaspsw" class="btn btn-primary" />
									</div>
								</div>
							</div>
