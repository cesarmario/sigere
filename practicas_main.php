					...
					<div class="popup dropdown-menu dropdown-menu-right">
                        <div class="thumbnail">
                            <div class="caption text-center">
                                <h6><?PHP echo $_SESSION['sesion_UserNom'];?> <small>Matricula: <?PHP echo $_SESSION['sesion_UserMat'];?></small></h6>                                
                            </div>
                        </div>
                        <ul class="list-group">
	                ...
	                <div class="panel-body">
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
								<div class="row">
									<div class="col-md-2">
									<input type="text" class="form-control" placeholder="N&uacute;mero de bono" name="id_bono" tabindex="1" required>
									</div>
								</div>
							</div>
						</div>
                        ...
                        <div class="form-group">
							...
							<div class="col-md-2">
                            	<input type="text" class="form-control" data-mask="99/99/9999" placeholder="99/99/9999" name="fecha" tabindex="2" required>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" placeholder="Apellido y Nombre" name="paciente" tabindex="5"
							...
							<div class="col-sm-10">
								<div class="block-inner">
									<label class="checkbox-inline checkbox-primary">
										> 65: <input type="checkbox" class="styled" name="rec_mas65" value="rec_mas65" tabindex="6">
									</label>
                                    ...
                                    <label class="checkbox-inline checkbox-primary">
										Urgencia: <input type="checkbox" class="styled" name="rec_urg" tabindex="8">
									</label>
  
                                    <label class="checkbox-inline checkbox-primary">
										Fin de Semana: <input type="checkbox" class="styled" name="rec_fds" tabindex="9">
									</label>
  
                                    <label class="checkbox-inline checkbox-primary">
										Feriado: <input type="checkbox" class="styled" name="rec_fer" tabindex="10">
									</label>
  
                                    <label class="checkbox-inline checkbox-primary">
										Nocturno: <input type="checkbox" class="styled" name="rec_noc" tabindex="11">
									</label>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea rows="5" cols="5" class="form-control" placeholder="Detalle" name="observ" tabindex="12"></textarea>
							</div>
						</div>
                        <?PHP /* defined('fn',"")*/?>
