				...
				<ul class="navigation">
                    ...
                    <li>
						...
						<ul>
							...
							<li class="active"><a href="exportar.php">Exportar</a></li>
                        </ul>
                    </li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Exportar <small>Seleccione un periodo para Exportar</small></h3>
				</div>
			</div>
			<!-- /page header -->
				                        ...
				                        <tr>
				                            ...
				                            <td>	
												<div class="table-controls">
													...
													<a href="funciones/exportar_xls.php?periodo_m=<?PHP echo $per["periodo_m"]; ?>&periodo_a=<?PHP echo $per["periodo_a"]; ?>&idbkp=1" 
													class="btn btn-success btn-icon btn-xs tip" title="Exportar Maestro de Practicas">                                               
													<i class="icon-folder-download"></i></a>
											...
											<td>	
												<div class="table-controls">
													...
													<a href="funciones/exportar_xls.php?periodo_m=<?PHP echo $per["periodo_m"]; ?>&periodo_a=<?PHP echo $per["periodo_a"]; ?>&idbkp=2" 
													class="btn btn-success btn-icon btn-xs tip" title="Exportar Detalle de Practicas">                                               
													<i class="icon-folder-download"></i></a>
