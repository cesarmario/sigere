				...
				<ul class="navigation">
					...
					<li>
						...
						<ul>
							...
							<li class="active"><a href="#">Obras Sociales</a></li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Obras Sociales <small></small></h3>
				</div>
			</div>
			<!-- /page header -->
                ...
                <div class="col-sm-10">
                    <div class="row">
                        <div class="col-sm-6 has-feedback has-feedback">
                            <input type="text" class="form-control" placeholder="Ingrese el Nombre" name="os" required>
                            <input type="hidden" id="fn" name="fn" value="os_a"/>                           
                        </div>
            	...
            	<div class="col-md-6">
                	...
                	<div class="tab-pane active fade in" id="inside">     
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Obras Sociales </h6></div>
                            ...
                            <div class="table">
				                <table class="table">
                            		...
                            		$query="SELECT * FROM obras_sociales WHERE baja = 0";
				                    ...
				                    <tbody>
				                        <tr>
                                            ...
                                            <div class="table-controls">
                                                <a href="editar_datos.php?id=<?PHP echo $nn['id'];?>&nombre=<?PHP echo $nn['nombre'];?>&fn=os_u"
